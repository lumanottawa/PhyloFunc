...
def generate_branches(clade):
    ...
    return branches
# creat all of branches and write to tree_rename.csv
...
#calculate extend_taxon_composition_merge_all_nodes
...
for a in range(2, column_len):
    ...
    for b in range(2, column_len):
        ...
        dab_matrix_norm.to_csv('PhyloFun_distance.csv')
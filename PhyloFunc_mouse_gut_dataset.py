# This code calculates the PhyloFunc distance for the mouse gut microbiome dataset.
...
# Original data files in the folder \1_database_search_results\2_mouse gut microbiome

# Step1: Construct the tree branches table
# The phylogenetic tree file 16S-rRNA_ML-Tree_Rooted.NWK was constructed by MEGA 
...
# Read the preprocessed taxon-function file "preprocessed_data.csv" generated by database search using MetaLab

# This code calculates the PhyloFunc distance for a toy dataset.
# The code includes 3 Steps: construction of branches, creation of extended taxon composition table and PhyloFunc distance calculation
# Original data files in the folder \1_database_search_results\1_toy_dataset

# Step1: Construct the tree branches table
# The tree toy_dataset.nwk was constructed through direct writing."
...
# Step2: calculate tax_composition, function composition and weighted_function_composition table according to Taxon-Function Table
# Taxon-Function Table.csv are written directly.
...
# Step3: calculate PhyloFunc distance based on tables "weighted_function_composition_percentage" and "extend_taxon_composition_merge_all_nodes"
